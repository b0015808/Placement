			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="company" title="${message(code: 'placement_Opportunity.company.label', default: 'Company')}" />
					
						<g:sortableColumn property="job_title" title="${message(code: 'placement_Opportunity.job_title.label', default: 'Jobtitle')}" />
					
						<g:sortableColumn property="name" title="${message(code: 'placement_Opportunity.name.label', default: 'Name')}" />
				...
				<g:each in="${placement_OpportunityInstanceList}" status="i" var="placement_OpportunityInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: placement_OpportunityInstance, field: "company")}</td>
					
						<td>${fieldValue(bean: placement_OpportunityInstance, field: "job_title")}</td>
					
						<td>${fieldValue(bean: placement_OpportunityInstance, field: "name")}</td>
